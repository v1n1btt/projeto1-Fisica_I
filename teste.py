...
# Load bird images
player_bird_image = pygame.image.load(os.path.dirname(__file__) + "\\red.png")  # Replace path if needed
enemy_bird_image = pygame.image.load(os.path.dirname(__file__) + "\\green.png")    # Replace path if needed 
 
# Load background image
background_image = pygame.image.load(os.path.dirname(__file__) + "\\sky-blue.png")  # Replace path if needed
...
# Create buttons
quit_button_image = pygame.image.load(os.path.dirname(__file__) + "\\red.png")        # Replace path if needed
refresh_button_image = pygame.image.load(os.path.dirname(__file__) + "\\red.png")  # Replace path if needed
